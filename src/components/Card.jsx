...
const Card = () => {
  const cards = [
    {
      title: "શ્રી ક્ષેમકલ્યાણી માતાજી મંદિર – બિહોલા વંશની આશ્રયસ્થલી ",
    ...
    },
    {
      ...
      description: [
        ...
        "આ પવિત્ર મંદિર કરનસિંહ મોહબ્બતસિંહ ના સ્વખર્ચે નિર્માણ પામ્યું છે, જે સમગ્ર ગામ માટે એક મહત્વપૂર્ણ ધાર્મિક અને સાંસ્કૃતિક ઉપકાર છે.",
